...
public class TunnelGenerator : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetButtonDown("Fire1"))
        {
            ...
            Vector3 viewport = Camera.main.ViewportToWorldPoint(new Vector3(0.5f, 0.5f, 5.0f));
            Vector3 viewportTarget = Camera.main.ViewportToWorldPoint(new Vector3(0.5f, 0.5f, 40.0f));
            ...
            sourcePortal.transform.rotation = Quaternion.Euler(player.rotation.eulerAngles - new Vector3(0, 180, 0));
            targetPortal.transform.rotation = Quaternion.Euler(player.rotation.eulerAngles - new Vector3(0, 180, 0));
